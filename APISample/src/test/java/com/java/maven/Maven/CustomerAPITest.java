...
public class CustomerAPITest {
	...
	public void createCustomerWith401HttpStatus() {
		...
		requestParams.put("first_name", "Dibash");
		requestParams.put("last_name", "Sah");
		requestParams.put("phone", "412-4533-7890");
	...
	public void getCustomer() {
		...
		Response response = httpRequest.request(Method.GET, "/customers/3");
		int statusCode = response.getStatusCode();
	...
	public void updateCustomer() {
		...
		request.contentType(ContentType.JSON);
		JSONObject requestParams = new JSONObject();
		requestParams.put("first_name", "Abir");
		requestParams.put("last_name", "Hussain");
		requestParams.put("phone", "123-456-7890");
		request.body(requestParams.toJSONString());
		Response response = request.put("/customers/ucDHifG");
		int statusCode = response.getStatusCode();
